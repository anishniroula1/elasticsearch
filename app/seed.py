...
ENTITY_CATALOG = [
    ...
    # Spelling variations used by the fuzzy application search demo.
    ("E021", "VIKOTIC, Vlatka", "vikotic vlatka", "PERSON", True),
    ("E022", "GARCIA, Marven", "garcia marven", "PERSON", True),
    ("E023", "Elanor Roosevelt", "elanor roosevelt", "PERSON", False),
    ("E024", "Finch D. Starr", "finch d starr", "PERSON", False),
    (
        "E025",
        "Translators Worldwid",
        "translators worldwid",
        "ORGANIZATION",
        True,
    ),
    ...
    (
        "E028",
        "James Internationl Law",
        "james internationl law",
        "ORGANIZATION",
        False,
    ),
    ("E029", "John Preparar", "john preparar", "PERSON", False),
    ("E030", "Andrew M. Smyth", "andrew m smyth", "PERSON", False),
    ("E031", "Alexander Hamilton", "alexander hamilton", "PERSON", False),
    ("E032", "Alexander Hamilten", "alexander hamilten", "PERSON", False),
    (
        "E033",
    ...
    (
        "E038",
        "United Nations Developmant Program",
        "united nations developmant program",
        "ORGANIZATION",
        False,
    ),
    ...
    (
        "E049",
        "Human Rights Documentation Office",
        "human rights documentation office",
        "ORGANIZATION",
        False,
    ),
    (
        "E050",
        "Human Rights Documentaton Office",
        "human rights documentaton office",
        "ORGANIZATION",
        False,
    ),
    # Lower similarity examples. Use threshold=1 to see these in the API.
    ("E051", "Mohamad", "mohamad", "PERSON", False),
    ("E052", "Kabl", "kabl", "LOCATION", False),
    ("E053", "Kablu", "kablu", "LOCATION", False),
    ("E054", "Mexcio", "mexcio", "LOCATION", False),
    ("E055", "Mexicoo", "mexicoo", "LOCATION", False),
    ("E056", "Rusia", "rusia", "LOCATION", False),
    ("E057", "Al-Qaida", "al qaida", "ORGANIZATION", True),
    ("E058", "Andrew Smith", "andrew smith", "PERSON", False),
    (
        "E059",
        "United Group",
        "united group",
    ...
    ("E063", "James Law", "james law", "ORGANIZATION", False),
    (
        "E064",
        "Eleanor Rosvelt",
        "eleanor rosvelt",
...
def _fake_actions(count, start_id, timestamp):
    ...
    for offset in range(count):
        ...
        if random_values.random() < 0.72:
            # Include the first fuzzy variations often enough for easy testing.
            entity = random_values.choice(ENTITY_CATALOG[:30])
        else:
