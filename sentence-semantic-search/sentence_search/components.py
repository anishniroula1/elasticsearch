...
all_sentence_summary_service = AllSentenceSummaryService(sentence_summary_service)
...
paginated_sentence_key_search_service = PaginatedSentenceKeySearchService(
    opensearch_store,
